...
from XMARs_preprocess.extract_DRIVE import *
from XMARs_preprocess.pre_processing import *
from XMARs_Net import *
...
config.read('../hyper-parameter_DRIVE.txt')
...
for i in range(int(N_predicted/group)):
    ...
    visualize(total_img,path_experiment+name +"_Prediction"+str(i))
...
plt.savefig(path_experiment+"AUC.png")
...
plt.legend(loc="lower right")
plt.savefig(path_experiment+"XMARs_Net_performance.png")

threshold_confusion = 0.5
print("Confusion matrix: threshold of " +str(threshold_confusion))
...
file_perf = open(path_experiment+'XMARs_results.txt', 'w')

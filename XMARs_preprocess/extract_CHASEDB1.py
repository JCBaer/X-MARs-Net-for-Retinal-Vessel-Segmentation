...
def get_data_training(CHASEDB1_train_imgs_original,
                      CHASEDB1_train_groudTruth,
                      patch_height,
                      patch_width,
                      N_subimgs,
                      inside_FOV):
    train_imgs_original = load_hdf5(CHASEDB1_train_imgs_original)
    train_masks = load_hdf5(CHASEDB1_train_groudTruth)
...
def get_data_testing(CHASEDB1_test_imgs_original, CHASEDB1_test_groudTruth, Imgs_to_test, patch_height, patch_width):
    test_imgs_original = load_hdf5(CHASEDB1_test_imgs_original)
    test_masks = load_hdf5(CHASEDB1_test_groudTruth)
...
def get_data_testing_overlap(CHASEDB1_test_imgs_original, CHASEDB1_test_groudTruth, Imgs_to_test, patch_height, patch_width, stride_height, stride_width):
    test_imgs_original = load_hdf5(CHASEDB1_test_imgs_original)
    test_masks = load_hdf5(CHASEDB1_test_groudTruth)
...
def inside_FOV_DRIVE(i, x, y, CHASEDB1_masks):
    assert (len(CHASEDB1_masks.shape) == 4)
    assert (CHASEDB1_masks.shape[1] == 1)
    if (x >= CHASEDB1_masks.shape[3] or y >= CHASEDB1_masks.shape[2]):
        return False
    return CHASEDB1_masks[i, 0, y, x] > 0